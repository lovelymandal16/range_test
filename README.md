...
## Environments
- Preview: https://main--range_test--lovelymandal16.hlx.page/
- Live: https://main--range_test--lovelymandal16.hlx.live/
...
1. Open the `range_test` directory in your favorite IDE and start coding :)
